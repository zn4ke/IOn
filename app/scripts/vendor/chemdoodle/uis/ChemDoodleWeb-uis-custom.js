...
(function(math, monitor, actions, states, structures, SYMBOLS, m) {
    ...
    _.mousedown = function(e) {
        ...
        if (this.sketcher.isHelp || this.sketcher.isMobile && e.op.distance(new structures.Point(this.width - 20, 20)) < 10) {
...
(function(desktop, imageDepot, q) {
    ...
    _.getSource = function(buttonGroup) {
        var sb = [];
        if (this.toggle) {
            sb.push('<input type="radio" style="display:none;" name="');
            sb.push(buttonGroup);
            sb.push('" id="');
            sb.push(this.id);
            sb.push('" title="');
            sb.push(this.tooltip);
            sb.push('" /><label class="btn btn-default btn-xs" for="');
            sb.push(this.id);
            sb.push('"><img id="');
            sb.push(this.id);
            sb.push('_icon" title="');
            ...
            sb.push('<button class="btn btn-default btn-xs" id="');
            sb.push(this.id);
...
(function(desktop, imageDepot, q, document) {
    ...
    _.getButtonSource = function() {
        var sb = [];
        sb.push('<button class="btn btn-primary btn-xs" id="');
        sb.push(this.id);
        sb.push('" onclick="return false;" title="');
        sb.push(this.tooltip);
        sb.push('"><img title="');
...
(function(c, math, monitor, actions, states, structures, SYMBOLS, m, m4) {
    ...
    _.mousedown = function(e) {
        ...
        // must also check for mobile hits here to the help button
        if (this.editor.isHelp || this.editor.isMobile && e.op.distance(new structures.Point(this.width - 20, 20)) < 10) {
...
(function(actions, states, structures, d3, q) {
    ...
    _.innermousemove = function(e) {
        ...
        var obj = this.editor.pick(e.p.x, e.p.y);
...
(function(c, extensions, featureDetection, d3, sketcherPack, structures, tools, q, m, m4, window) {
    ...
    _.drawChildExtras = function(gl) {
        ...
        var projectionMatrix = m4.create();
